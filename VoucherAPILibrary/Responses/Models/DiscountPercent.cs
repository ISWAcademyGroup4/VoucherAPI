...
namespace VoucherAPILibrary.Responses
{
    public class DiscountPercent : BaseVoucherEntity
    {
        ...
        public DiscountPercent(string code, string campaign, string voucherType, string discountType, int percentOff, long amountLimit, int redemptionCount, int redeemedCount, bool isRedeemed, decimal redeemedAmount, DateTime startDate, DateTime expirationDate, bool active, DateTime creationDate, ServiceResponse serviceResponse)
        {
