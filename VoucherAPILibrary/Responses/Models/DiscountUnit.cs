...
namespace VoucherAPILibrary.Responses
{
    public class DiscountUnit : BaseVoucherEntity
    {
        ...
        public DiscountUnit(string voucherCode, string campaignName, string type, string discountType, string unitOff, int redemptionCount, 
            int redeemedCount, bool isRedeemed, decimal redeemedAmount, DateTime startDate, DateTime expiryDate, bool status, DateTime dateCreated)
        {
