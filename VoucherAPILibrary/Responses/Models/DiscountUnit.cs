...
namespace VoucherAPILibrary.Responses
{
    public class DiscountUnit : BaseVoucherEntity
    {
        ...
        public DiscountUnit(string code, string campaign, string voucherType, string discountType, string unitOff, int redemptionCount, int redeemedCount, bool isRedeemed, decimal redeemedAmount, DateTime startDate, DateTime expirationDate, bool active, DateTime creationDate, ServiceResponse serviceResponse)
        {
